...
import {IRouterClient} from "src/v0.8/ccip/interfaces/IRouterClient.sol";
import {Client} from "src/v0.8/ccip/libraries/Client.sol";
...
contract TransferTokens is Script {
    ...
    function run() external {
        ...
        Client.EVM2AnyMessage memory message = Client.EVM2AnyMessage({
            receiver: abi.encode(deployer), // Receiver address on the destination chain
