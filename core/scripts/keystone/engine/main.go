...
import (
	...
	"github.com/smartcontractkit/chainlink/core/scripts/keystone/engine/utils"
...
func main() {
	...
	engine, err := utils.NewStandaloneEngine(ctx, lggr, registry, binary, config)
	if err != nil {
		fmt.Printf("Failed to create engine: %v\n", err)
		os.Exit(1)
	}

	capabilities, err := utils.NewFakeCapabilities(ctx, lggr, registry)
	if err != nil {
